...
echo ""
echo "📝 IMPORTANT: Configure your git credentials"
echo "   1. Copy the example file:"
echo "      cp .envrc.local.example .envrc.local"
echo ""
echo "   2. Edit .envrc.local and set your git credentials:"
echo "      export GIT_USER_NAME=\"Your Name\""
echo "      export GIT_USER_EMAIL=\"your@email.com\""
echo ""
echo "   3. Allow direnv and reapply Home Manager:"
echo "      direnv allow"
echo "      home-manager switch --flake .#user@linux"
echo ""
